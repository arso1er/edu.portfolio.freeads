            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                        <div class="col">
                            <a href="/user/my-ads" class="card h-100">
                                <div class="baz-card-anim">
                                    <img src="/images/my-ads.png" class="card-img-top" alt="My ads">
                                </div>
                                <div class="card-body d-flex flex-column">
                                    <h5 class="fw-bold text-center">My ads</h5>
                                </div>
                            </a>
                        </div>
                        <div class="col">
                            <a href="/user/ads/create" class="card h-100">
                                <div class="baz-card-anim">
                                    <img src="/images/new-ad.png" class="card-img-top" alt="Create new ad">
                                </div>
                                <div class="card-body d-flex flex-column">
                        ...
                        <div class="col">
                            <a href="/profile" class="card h-100">
                                <div class="baz-card-anim">
                                    <img src="/images/user-default.png" class="card-img-top" alt="My profile">
                                </div>
                                <div class="card-body d-flex flex-column">
                        ...
                        <div class="col">
                            <a href="#" class="card h-100" data-bs-toggle="modal" data-bs-target="#user-{{ $user->id }}">
                                <div class="baz-card-anim">
                                    <img src="/images/remove-profile.png" class="card-img-top" alt="Remove account">
                                </div>
                                <div class="card-body d-flex flex-column">
