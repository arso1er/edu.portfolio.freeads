            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('register') }}">
                        ...
                        <div class="mb-3 row">
                            <label for="login" class="col-md-4 col-form-label text-md-end">{{ __('Login/username') }}</label>
                        ...
                        <div class="mb-3 row">
                            <label for="admin" class="col-md-4 col-form-label text-md-end">{{ __('Admin password') }}</label>
